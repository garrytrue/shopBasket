...
public class PurchaseDataBase extends SQLiteOpenHelper {
	...
	private static final String CREATE_TABLE_ITEM = "CREATE TABLE "
			...
			+ " TEXT not null collate nocase, " + ITEM_STATUS
			+ " INTEGER not null" + ")";
	...
	private static final String CREATE_TABLE_PURCHASE = "CREATE TABLE "
			+ TABLE_PURCHASE + "( " + KEY_ID_PURHCASE
			+ " INTEGER PRIMARY KEY AUTOINCREMENT," + DATE_PURCHASE
			+ " DATETIME," + PURCHASE_FROM_ITEM + " INTEGER not null,"

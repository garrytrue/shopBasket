...
public class DataBaseIO {
	...
	public void addItemStatus(int status, int updateID) {
		...
		updateSQLRequest = "UPDATE " + PurchaseDataBase.TABLE_ITEM + " SET "
				+ PurchaseDataBase.ITEM_STATUS + "=" + String.valueOf(status)
				+ " WHERE " + PurchaseDataBase.KEY_ID_ITEM + "="
	...
	public Cursor getAllItemCursor() {
		...
		String selectionRequest = "SELECT * FROM "
				+ PurchaseDataBase.TABLE_ITEM + " ORDER BY "
				+ PurchaseDataBase.ITEM_NAME;
		// Cursor c = db.query(PurchaseDataBase.TABLE_ITEM, null, null, null,
		// null, null, PurchaseDataBase.ITEM_NAME);
	...
	public void renameItemName(String newName, int updateID) {
		String updateSQLRequest = "UPDATE " + PurchaseDataBase.TABLE_ITEM
				+ " SET " + PurchaseDataBase.ITEM_NAME + "=" + "'" + newName
				+ "'" + " WHERE " + PurchaseDataBase.KEY_ID_ITEM + "="
				+ String.valueOf(updateID);
		Log.i(TAG, updateSQLRequest);
		db.execSQL(updateSQLRequest);
	...
	public void deleteSingleItem(int indexInList) {
		...
		db.delete(PurchaseDataBase.TABLE_ITEM, PurchaseDataBase.KEY_ID_ITEM
				+ " = " + indexInList, null);
	...
	public void statusToDefalt() {
		String updateSQLRequest = "UPDATE " + PurchaseDataBase.TABLE_ITEM
				+ " SET " + PurchaseDataBase.ITEM_STATUS + "=" + "0"
				+ " WHERE " + PurchaseDataBase.ITEM_STATUS + "=" + "1";
		db.execSQL(updateSQLRequest);
	 ...
	 * Add Purchase
	 * 
	 * where selectedIDs ArrayList<> of selected _id from Table_Item where date
	 * contains date put in DatePicker Dialog
	 */
	...
	public void addPurchase(Date date, ArrayList<Integer> selectedIDs) {
		...
		try {
			for (Integer selectedID : selectedIDs) {
				...
				// For Test's
				Log.i(TAG, "Insert one row: date=" + date.toString()
						+ " idItem= " + String.valueOf(selectedID));
			}
	...
	public Cursor getTestCursor() {
		...
		Cursor c = db.query(PurchaseDataBase.TABLE_PURCHASE, null, null, null,
				null, null, null);
		return c;
	}
	...
	public Cursor getAllPurchasesCursor() {
		...
		String sqliteQuery = "SELECT " + PurchaseDataBase.TABLE_PURCHASE + "."
				+ PurchaseDataBase.KEY_ID_PURHCASE + ", "
				+ PurchaseDataBase.TABLE_PURCHASE + "."
				+ PurchaseDataBase.DATE_PURCHASE + ", "
				+ PurchaseDataBase.TABLE_ITEM + "."
				+ PurchaseDataBase.ITEM_NAME + ", "
				+ PurchaseDataBase.TABLE_PURCHASE + "."
				+ PurchaseDataBase.PURCHASE_STATUS + " FROM "
				+ PurchaseDataBase.TABLE_PURCHASE + " INNER JOIN "
				+ PurchaseDataBase.TABLE_ITEM + " ON "
				+ PurchaseDataBase.TABLE_PURCHASE + "."
				+ PurchaseDataBase.PURCHASE_FROM_ITEM + "="
				+ PurchaseDataBase.TABLE_ITEM + "."
				+ PurchaseDataBase.KEY_ID_ITEM + " GROUP BY "
				+ PurchaseDataBase.TABLE_PURCHASE + "."
				+ PurchaseDataBase.DATE_PURCHASE;
	...
	public Cursor getPurchasebyDate(String dateforGetChild) {
		...
		String sqliteQuery = "SELECT " + PurchaseDataBase.TABLE_PURCHASE + "."
				+ PurchaseDataBase.KEY_ID_PURHCASE + ", "
				/*
				 * PurchaseDataBase.TABLE_PURCHASE+"."+PurchaseDataBase.
				 * DATE_PURCHASE+", "
				 */+ PurchaseDataBase.TABLE_ITEM + "."
				+ PurchaseDataBase.ITEM_NAME + ", "
				+ PurchaseDataBase.TABLE_PURCHASE + "."
				+ PurchaseDataBase.PURCHASE_STATUS + " FROM "
				+ PurchaseDataBase.TABLE_PURCHASE + " INNER JOIN "
				+ PurchaseDataBase.TABLE_ITEM + " WHERE "
				+ PurchaseDataBase.TABLE_PURCHASE + "."
				+ PurchaseDataBase.PURCHASE_FROM_ITEM + "="
				+ PurchaseDataBase.TABLE_ITEM + "."
				+ PurchaseDataBase.KEY_ID_ITEM + " AND "
				+ PurchaseDataBase.TABLE_PURCHASE + "."
				+ PurchaseDataBase.DATE_PURCHASE + " = " + "'"
				+ dateforGetChild + "'";
	...
	public void deletePurchaseBagbyDate(String date) {
		db.delete(PurchaseDataBase.TABLE_PURCHASE,
				PurchaseDataBase.DATE_PURCHASE + "=" + "'" + date + "'", null);
	}
	...
	public void setStatusOfPurchaseItem(int status, long itemID) {
		...
		updateSQLRequest = "UPDATE " + PurchaseDataBase.TABLE_PURCHASE
				+ " SET " + PurchaseDataBase.PURCHASE_STATUS + "="
				+ String.valueOf(status) + " WHERE "
				+ PurchaseDataBase.KEY_ID_PURHCASE + "="
	...
	public boolean getStatusofPurchaseItem(long itemId) {
		int statusINT;
		String getCurrentStatus = "SELECT " + PurchaseDataBase.TABLE_PURCHASE
				+ "." + PurchaseDataBase.PURCHASE_STATUS + " FROM "
				+ PurchaseDataBase.TABLE_PURCHASE + " WHERE "
				+ PurchaseDataBase.KEY_ID_PURHCASE + "="
				+ String.valueOf(itemId);
		Cursor c = db.rawQuery(getCurrentStatus, null);
		c.moveToFirst();
		do {
			statusINT = c.getInt(c
					.getColumnIndex(PurchaseDataBase.PURCHASE_STATUS));

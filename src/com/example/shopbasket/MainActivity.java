...
public class MainActivity extends Activity implements LoaderCallbacks<Cursor> {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPurchaseAdapter = new PurchaseAdapter(this, c,
				R.layout.collapsed_group, R.layout.expanded_group, groupFrom,
				groupTo, R.layout.item_layout, childFrom, childTo);
	...
	public void onCreateContextMenu(ContextMenu menu, View view,
		...
		ExpandableListView.ExpandableListContextMenuInfo elMenuInfo = (ExpandableListView.ExpandableListContextMenuInfo) menuinfo;

		int whereTap = ExpandableListView
				.getPackedPositionType(elMenuInfo.packedPosition);

		// Check for tap in group, NOT in children (whereTap for group ALWAYS =
		// 0)
		if (whereTap == 0)
	...
	public boolean onContextItemSelected(MenuItem menuItem) {
		...
		ExpandableListView.ExpandableListContextMenuInfo elMenuInfo = (ExpandableListView.ExpandableListContextMenuInfo) menuItem
				.getMenuInfo();
		int groupPositioninContextMenu = ExpandableListView
				.getPackedPositionGroup(elMenuInfo.packedPosition);
		Log.i(TAG,
				"Position in List: "
						+ String.valueOf(groupPositioninContextMenu));

		switch (menuItem.getItemId()) {
		case R.id.delete_bag:
			Cursor c = mDataBaseIO.getAllPurchasesCursor();
			c.moveToPosition(groupPositioninContextMenu);
			String datetoDelete = c.getString(c
					.getColumnIndex(PurchaseDataBase.DATE_PURCHASE));
			...
			Toast.makeText(MainActivity.this,
					"Bag " + datetoDelete + " was deleted", Toast.LENGTH_SHORT)
					.show();
			break;
	...
	public class PurchaseAdapter extends SimpleCursorTreeAdapter {
		...
		protected Cursor getChildrenCursor(Cursor groupCursor) {
			...
			String dateForChild = groupCursor.getString(groupCursor
					.getColumnIndex(PurchaseDataBase.DATE_PURCHASE));
		...
		public void bindChildView(View view, final Context context,
			...
			final float itemStatus = cursor.getFloat(cursor
			...
			if (itemStatus == CHECKED) {
				...
				mChildViewHolder.currentchildTextView
						.setPaintFlags(mChildViewHolder.currentchildTextView
			...
			view.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if (itemStatus == CHECKED) {
						...
						Toast.makeText(context, "I not buy this yet",
								Toast.LENGTH_SHORT).show();
						// Set invisible image
						mChildViewHolder.currentchildImageView
								.setAlpha(UNCHEKED);
						...
						Toast.makeText(context, "I buy this now",
								Toast.LENGTH_SHORT).show();
						// Set visible image
						mChildViewHolder.currentchildImageView
								.setAlpha(CHECKED);
		...
		public View newChildView(Context context, Cursor cursor,
			...
			View currentChildView = mLayoutInflater.inflate(
					R.layout.item_layout, parent, false);
			mChildViewHolder.currentchildTextView = (TextView) currentChildView
					.findViewById(R.id.itemName);
			mChildViewHolder.currentchildImageView = (ImageView) currentChildView
